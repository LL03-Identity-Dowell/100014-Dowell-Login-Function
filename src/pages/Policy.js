...
const Policy = () => {
  return (
    <div className="mx-auto max-w-7xl space-y-1 px-4 py-2">
      ...
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h3 className="font-bold text-2xl">Interpretation and Definitions</h3>
      <h6 className="font-semibold text-2xl">Interpretation</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-2xl">Definitions</h6>
      <div>
        <p className="font-normal pl-6 space-y-2 leading-relaxed">
          For the purposes of this Privacy Policy:{" "}
        </p>

        <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
          <li>
          ...
          <li>
            ...
            to DoWell Research Pte Limited, Nivel 42, Six Battery Road
            Singapur-049909, SG100008 For the purpose of the GDPR, the Company
          ...
          <li>
            ...
            the Company as the legal person who alone or jointly with others
          ...
          <li>
            " <span className="font-semibold">Website</span> " refers to Dowell
            Login accessible from http://100014.pythonanywhere.com/
          </li>
          <li>
            ...
            Service, as applicable. Under GDPR (General Data Protection
            Regulation), You can be referred to as the Data Subject or as the
      ...
      <h5 className="font-semibold text-2xl">Types of Data Collected</h5>
      <h6 className="font-semibold text-2xl">Personal Data</h6>
      ...
      <h6 className="font-semibold text-2xl">Usage Data</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        <li>
          <span className="font-semibold">Cookies or Browser Cookies.</span> A
        ...
        <li>
          <span className="font-semibold">Flash Cookies.</span> Certain sections
      ...
      <h6 className="font-semibold text-2xl">Use of Your Personal Data</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        ...
        <li>
          ...
          and events that we offer that are similar to those that you have
        ...
        <li>
          ...
          divestiture, restructuring, reorganization, dissolution, or another
          ...
          in which Personal Data held by Us about our Service users is among the
          assets transferred.
        </li>
        <li>
      ...
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        <li>
          <span className="font-semibold"> With Service Providers:</span> We may
        ...
        <li>
          <span className="font-semibold"> For business transfers:</span> We may
        ...
        <li>
          <span className="font-semibold"> With Affiliates:</span> We may share
        ...
        <li>
          <span className="font-semibold"> With business partners</span>: We may
      ...
      <h6 className="font-semibold text-2xl">Transfer of Your Personal Data</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Business Transactions</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Law enforcement</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Other legal requirements</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-2xl">Security of Your Personal Data</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-2xl">Analytics</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
        We may use third-party Service providers to monitor and analyze the use
        of our Service.
      </p>

      <h6 className="font-semibold text-2xl">Email Marketing</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
        ...
        the PCI Security Standards Council. PCI-DSS requirements help ensure the
        secure handling of payment information.
      </p>

      <h5 className="font-semibold text-2xl">GDPR Privacy Policy</h5>
      ...
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        ...
        <li>
          <span className="font-semibold"> Public interests :</span>
      ...
      <h6 className="font-semibold text-xl">Your Rights under the GDPR</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        ...
        <li>
          <span className="font-semibold">Withdraw Your consent.</span>
      ...
      <h6 className="font-semibold text-xl">Children's Privacy</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Links to Other Websites</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Changes to this Privacy Policy</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
      ...
      <h6 className="font-semibold text-xl">Contact Us</h6>
      <p className="font-normal pl-6 space-y-2 leading-relaxed">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="list-disc list-inside pl-6 space-y-2 font-normal leading-relaxed">
        <li>By visiting this page on our website: https://uxlivinglab.com/</li>
        <li>By sending us an email: uxlivinglab@dowellresearch.sg</li>
      </ul>
          ...
          <div className="mt-4 space-y-6">
            <div className="relative flex gap-x-3">
              ...
              <div className="text-sm leading-6">
                <p className="text-green-600">I agree</p>
              </div>
            </div>
          </div>
        </fieldset>
